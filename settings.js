...
global.alivemsg = `@| 𝐃𝐈𝐍𝐔𝐖𝐀 𝐎𝐅𝐅𝐈𝐂𝐈𝐀𝐋 𝐁𝐎𝐓™💖🎧🚶🏻‍♂️

🎗 ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ ᴛʜᴇ ᴏᴜʀ ɢʀᴏᴜᴘ 🎗

ɴᴏ ꜱᴀᴘᴍ
ᴏɴ ꜱᴇx ᴠɪᴅᴇᴏ ᴀɴᴅ ᴘʜᴏᴛᴏ ꜱᴇɴᴅ 
ɴᴏ ꜱʜᴀʀᴇ ɢᴏʀᴜᴘ ʟɪɴᴋ
ɴᴏ ʙᴀᴅ ᴡᴏʀᴅꜱ

📌📎මේක  𝐁𝐎𝐓 𝐆𝐑𝐎𝐔𝐏 එකක්.
📌🖇️ඔයාලාට 𝐒𝐎𝐍𝐆, 𝐕𝐈𝐃𝐄𝐎, 𝐓𝐈𝐊𝐓𝐎𝐊 𝐕𝐈𝐃𝐄𝐎, 𝐏𝐇𝐎𝐓𝐎, 𝐋𝐎𝐆𝐎, 𝐄𝐇𝐈 ගොඩාක් දේවල් ගන්න පුලුවන්
📌🖇️නරක ඒවා ඉල්ලන්න එපා.
📌🖇️ 𝐁𝐎𝐓 ගේ 𝐈𝐍𝐁𝐎𝐗 ගිහිම් ඉල්ලලා කරදර කරන්න එපා.
*📌🖇️𝐋𝐈𝐍𝐊 දාන්න එපා 𝐀𝐔𝐓𝐎 𝐑𝐄𝐌𝐎𝐕𝐄𝐃 වෙයි.*

ＧＲＯＵＰ ＬＩＮＫ 🚶‍♂️🌿

https://chat.whatsapp.com/HmPab8gKqHkAbcOSjY7UO0` //Costomize Alive Message (type your message in `` )
...
//owner v card
global.vcardowner = ['+94785196707'] // owner number
global.ownername = "ꪶ 𝐃𝐈𝐍𝐔𝐖𝐀 x 𝐎𝐅𝐅𝐈𝐂𝐈𝐀𝐋 ꫂ ❤👀™〽️" // owner name
global.ytname = "" // yt chanel name
global.socialm = "GitHub: prabhasha2006" // github or insta name
global.location = "India, Mizoram, Aizawl" // location

//bot body 
global.alivepic = `https://i.ibb.co/hc52VJt/IMG-1666093858257.jpg` // alive picture \\ use "https://ibb.com" to upload photos. < 1 MB
...
global.owner = ['+94785196770']
global.ownertag = '+94785196770' //your tag number
global.botname = 'ꪶ 𝐃𝐈𝐍𝐔𝐖𝐀 x 𝐎𝐅𝐅𝐈𝐂𝐈𝐀𝐋 ꫂ ❤👀™〽️' //ur bot name
global.packname = "ꪶ 𝐃𝐈𝐍𝐔𝐖𝐀 x 𝐎𝐅𝐅𝐈𝐂𝐈𝐀𝐋 ꫂ ❤👀™〽️" // sticker packname
global.author = "ꪶ 𝐃𝐈𝐍𝐔𝐖𝐀 x 𝐎𝐅𝐅𝐈𝐂𝐈𝐀𝐋 ꫂ ❤👀™〽️" // sticker author
global.dragonemoji = '🧩' // Menu emoji
global.footer = 'ꪶ 𝐃𝐈𝐍𝐔𝐖𝐀 x 𝐎𝐅𝐅𝐈𝐂𝐈𝐀𝐋 ꫂ ❤👀™〽️' //
...
global.mess = {
    ...
    spam: '⚠️ [SPAM] Detected ⚠️\n\nThe emergency security system was activated.\n\nPowered By: * ꪶ 𝐃𝐈𝐍𝐔𝐖𝐀 x 𝐎𝐅𝐅𝐈𝐂𝐈𝐀𝐋 ꫂ ❤👀™〽️*',
    caption: 'Generated by: ◉ * ꪶ 𝐃𝐈𝐍𝐔𝐖𝐀 x 𝐎𝐅𝐅𝐈𝐂𝐈𝐀𝐋 ꫂ ❤👀™〽️*'
} // END \\
    global.limitawal = {
    premium: "Infinity",
    free: 12,
